...
export default function Home() {
  ...
  return <main className="shell landing-shell">
    <nav className="nav"><a className="brand" href="/">leash<span>.</span>agent</a><div className="navlinks"><a href="#story">Why Leash</a><a href="#decision">Try the gate</a><a href="#audit">Audit trail</a><a className="nav-cta" href="/demo">Watch the flow <span>↗</span></a></div></nav>
